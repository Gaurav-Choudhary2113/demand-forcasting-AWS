...
const ModelPage = () => {
  ...
  return (
    ...
    >
      ...
      {/* <div className="w-full mt-10 flex justify-center items-center "><form action="" className="h-80 w-1/3 flex flex-col justify-center items-center border-2 border-[#82f0ff00] rounded-md bg-[#ffffff16] ">
        <input type="date" className="m-5" /> <button type="submit" className="px-3 py-2 m-10 rounded border-2 shadow-md shadow-black">Submit</button></form></div> */}
